...
public class Fragment_PlaylistDetail1 extends Fragment  implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (NetworkConnection.isConnectedToInternet(getActivity())) {
            ...
            new Json_PlaylistDetail(getActivity(),list).execute(Adapter_FeaturedPlaylist.pid,user_id);
        ...
        MainActivity1.tv_bck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment_FeaturedPlaylist fragment=new Fragment_FeaturedPlaylist();
