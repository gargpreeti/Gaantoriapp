...
public class Fragment_Privacy extends Fragment  implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activity_privacy, container, false); //inflate view
...
// To open webview
        ...
        webView.loadUrl(RegisterUrl.privacypolicy);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            view.loadUrl(RegisterUrl.privacypolicy);
            return true;
        }
    }
