...
public class Fragment_PlaylistDetailUser extends Fragment  implements View.OnClickListener {
    ...
    view = inflater.inflate(R.layout.activity_playlistdetail, container, false); //inflate the view
        ...
        tv_main.setText(Adapter_MyPlaylist_Music.listname);
        ...
        if (NetworkConnection.isConnectedToInternet(getActivity())) {
            ...
            new Json_PlaylistDetail(getActivity(),list).execute(Adapter_MyPlaylist_Music.pid,user_id);
        }
        else {
        ...
        MainActivity1.tv_bck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment_MyMusic fragment=new Fragment_MyMusic();
