...
public class Json_Saveplaylist_songlib extends AsyncTask<String, String, String> {
...
String playlistid;
       public Json_Saveplaylist_songlib(Context context) {
    ...
    protected void onPostExecute(String result) {
        ...
        new Json_saveplaylistsong(context).execute(Fragment_Home1.user_id,playlistid, Adapter_LibrarySong.songid,"1");
