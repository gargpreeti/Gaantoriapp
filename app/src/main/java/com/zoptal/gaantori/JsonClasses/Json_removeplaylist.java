...
public class Json_removeplaylist extends AsyncTask<String, String, String> {

     String res="",sn,st,uname,uemail;
     Context context;
     ProgressDialog loading;

       public Json_removeplaylist(Context context) {
    ...
    protected void onPostExecute(String result) {
        ...
        Toast.makeText(context, "Playlist removed Successfully!", Toast.LENGTH_SHORT).show();
