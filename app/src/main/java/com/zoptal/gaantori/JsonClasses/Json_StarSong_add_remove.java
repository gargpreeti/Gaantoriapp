...
public class Json_StarSong_add_remove extends AsyncTask<String, String, String> {
    ...
    ProgressDialog loading;
       ...
       public Json_StarSong_add_remove(Context context) {
    ...
    protected void onPostExecute(String result) {
        ...
        Toast.makeText(context, "Song added to favorites Successfully!", Toast.LENGTH_SHORT).show();
