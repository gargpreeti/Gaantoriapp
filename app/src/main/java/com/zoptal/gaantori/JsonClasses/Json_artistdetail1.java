...
public class Json_artistdetail1 extends AsyncTask<String, String, String> {
    ...
    public Json_artistdetail1(Context context, ListView list) {
        ...
        try {
            ...
            if (entity != null) {
               ...
               String artistimage= main_obj.getString("artistimages").replace(" ", "%20");
                ...
                JSONArray ary_songs= main_obj.getJSONArray("topalbums");
