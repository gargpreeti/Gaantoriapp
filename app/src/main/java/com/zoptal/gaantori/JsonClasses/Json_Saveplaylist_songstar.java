...
public class Json_Saveplaylist_songstar extends AsyncTask<String, String, String> {
    ...
    ProgressDialog loading;
     String playlistid;
       ...
       public Json_Saveplaylist_songstar(Context context) {
    ...
    protected void onPostExecute(String result) {
        ...
        new Json_saveplaylistsong(context).execute(Fragment_Home1.user_id,playlistid, Adapter_StaredSong.songid,"1");
