...
public class Json_BrowseAlbum extends AsyncTask<String, String, String> {
    ...
    public Json_BrowseAlbum(Context context, Adapter_NewRelease adapter_newRelease) {
