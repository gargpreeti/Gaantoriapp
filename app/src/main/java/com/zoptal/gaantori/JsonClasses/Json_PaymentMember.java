...
import com.zoptal.gaantori.Fragment.Fragment_PaymentMember;
...
public class Json_PaymentMember extends AsyncTask<String, String, String> {

   public static String res="",res1,successurl,failure_url;
    Context context;
    ProgressDialog loading;

    public Json_PaymentMember(Context context) {
    ...
    protected void onPostExecute(String result) {
        ...
        if(res1.equals("true")){
            ...
            Fragment_PaymentMember fragment_detail=new Fragment_PaymentMember();
