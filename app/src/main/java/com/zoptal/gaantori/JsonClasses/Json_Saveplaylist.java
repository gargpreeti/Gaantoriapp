...
public class Json_Saveplaylist extends AsyncTask<String, String, String> {
    ...
    ProgressDialog loading;
       ...
       public Json_Saveplaylist(Context context) {
    ...
    protected void onPostExecute(String result) {
        ...
        for(int i=0;i<Json_albumdetailAll.model_albumDetail.getAl_songs().size();i++) {
            ...
            new Json_saveplaylistsong(context).execute(Fragment_Home1.user_id,playlistid,Adapter_AlbumDetail.m.getAl_songs().get(i).getId(), "1");
