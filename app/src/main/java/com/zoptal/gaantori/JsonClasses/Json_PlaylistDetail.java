...
public class Json_PlaylistDetail extends AsyncTask<String, String, String> {

    ProgressDialog loading;
    Context context;
    ListView list;

    public static ArrayList<TopSongs> al_playlistsong;


    public Json_PlaylistDetail(Context context, ListView list) {
    ...
    protected String doInBackground(String... params) {
        ...
        HttpPost httppost = new HttpPost(
                RegisterUrl.userplaylistsong);


        try {
            // Add your data
             List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
             nameValuePairs.add(new BasicNameValuePair("p_id",params[0]));
            ...
            if (entity != null) {
                ...
                JSONObject main_obj = new JSONObject(result);
                 al_playlistsong = new ArrayList<TopSongs>();

                JSONArray ary_products =main_obj.getJSONArray("records");

                for (int i = 0; i < ary_products.length(); i++) {

                    JSONObject obj = ary_products.getJSONObject(i);
                    String id = obj.getString("id");
                    String stitle= obj.getString("song_title");
                    ...
                    String url= obj.getString("song_url").replace(" ", "%20");
    ...
    protected void onPostExecute(String result) {
        ...
        list.setAdapter(new Adapter_MyPlaylistdetail(context, al_playlistsong));
