...
public class Json_Saveplaylistmyplaylist extends AsyncTask<String, String, String> {
    ...
    ProgressDialog loading;
       ...
       public Json_Saveplaylistmyplaylist(Context context) {
    ...
    protected void onPostExecute(String result) {
        ...
        loading.dismiss();
            new Json_saveplaylistsong(context).execute(Fragment_Home1.user_id,playlistid,Adapter_MyPlaylistdetail.songid, "1");
