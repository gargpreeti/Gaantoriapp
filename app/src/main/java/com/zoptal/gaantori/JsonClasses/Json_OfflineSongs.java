...
public class Json_OfflineSongs extends AsyncTask<String, String, String> {
    ...
    ProgressDialog loading;
       ...
       public Json_OfflineSongs(Context context) {
    ...
    protected void onPostExecute(String result) {
        ...
        loading.dismiss();
        Toast.makeText(context, "song saved successfully!", Toast.LENGTH_LONG).show();
