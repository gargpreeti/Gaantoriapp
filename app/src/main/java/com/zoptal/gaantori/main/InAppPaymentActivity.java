...
public class InAppPaymentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean isNetworkAvailable() {
        ...
        boolean connected = false;
            ...
            ConnectivityManager connectivityManager = (ConnectivityManager) InAppPaymentActivity.this.getSystemService(Context.CONNECTIVITY_SERVICE);
               ...
               try {
                  ...
                  if (productId.contains("monthly")) {
                    ...
                    amount = "1";
                      ...
                      if (NetworkConnection.isConnectedToInternet(InAppPaymentActivity.this)) {

                          new Json_PaymentInApp(InAppPaymentActivity.this).execute("Save", Json_SignUp.id,productId,orderId,amount,"Month");                 }
                      else {
                          Toast.makeText(InAppPaymentActivity.this,"Please Check your internet connection", Toast.LENGTH_SHORT).show();
                     ...
                     //subscription_level = 30;
                      ...
                      if (NetworkConnection.isConnectedToInternet(InAppPaymentActivity.this)) {
                          ...
                          new Json_PaymentInApp(InAppPaymentActivity.this).execute("Save", Json_SignUp.id,productId,orderId,amount,"Year");              }
                      else {
                          Toast.makeText(InAppPaymentActivity.this,"Please Check your internet connection", Toast.LENGTH_SHORT).show();
                  ...
                  if(response==0){
                      ...
                      Toast.makeText(InAppPaymentActivity.this,"You have already subscribed for this plan", Toast.LENGTH_LONG).show();
