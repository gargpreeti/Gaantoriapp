...
import com.zoptal.gaantori.JsonClasses.Json_Saveplaylistmyplaylist;
import com.zoptal.gaantori.JsonClasses.Json_StarSong_add_remove;
import com.zoptal.gaantori.JsonClasses.Json_removeplaylistsong;
...
public class Adapter_MyPlaylistdetail extends BaseAdapter {
...
public static String songid;
	public Adapter_MyPlaylistdetail(Context context, ArrayList<TopSongs> al_playlistsong) {
	...
	public View getView( final int position, View convertView, ViewGroup parent) {
		...
		if ((activity1.playingTAG.equalsIgnoreCase("Adapter_MyPlaylistdetail")) && (position==activity1.playingPosition)) {
		...
		String downloadedvalue=al_playlistsong.get(position).getDownloaded().toString().trim();
		...
		if(Fragment_Home1.utype1.equals("Premium")) {
			...
			holder.rel.setClickable(true);
		}
		else{
			holder.rel.setClickable(false);
      		}
		holder.rel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				activity1.playingTAG="Adapter_MyPlaylistdetail";
				activity1.playingPosition=position;
				holder.btn.setBackgroundResource(R.mipmap.current_song);
				notifyDataSetChanged();
				activity1.setListOnPlayer(Json_PlaylistDetail.al_playlistsong, position,false,Adapter_MyPlaylistdetail.this);
				...
				add_list.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						if(Fragment_Home1.user_id.equals("null")) {
							...
							songid=al_playlistsong.get(position).getId();
				...
				remove_list.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						if(Fragment_Home1.user_id.equals("null")) {
							...
							if (NetworkConnection.isConnectedToInternet(context)) {
								...
								new Json_removeplaylistsong(context).execute(Fragment_Home1.user_id,Adapter_MyPlaylist_Music.pid,al_playlistsong.get(position).getId(),"0");
							}
							else {
								Toast.makeText(context,"Please Check your internet connection", Toast.LENGTH_SHORT).show();
					...
					public void onClick(View v) {
						if(Fragment_Home1.utype1.equals("Premium")) {
							...
							activity1.addSongToQueue(Json_PlaylistDetail.al_playlistsong.get(position));
			...
			public void onClick(View v) {
				...
				if(Fragment_Home1.user_id.equals("null")){
					...
					if (NetworkConnection.isConnectedToInternet(context)) {
						...
						new Json_Saveplaylistmyplaylist(context).execute(name,Fragment_Home1.user_id);
					}
					else {
						Toast.makeText(context,"Please Check your internet connection", Toast.LENGTH_SHORT).show();
		...
		list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (NetworkConnection.isConnectedToInternet(context)) {
					...
					new Json_saveplaylistsong(context).execute(Fragment_Home1.user_id, Json_MyPlaylist1.model_myPlaylist.getAl_myplaylist().get(position).getId(),al_playlistsong.get(pos).getId(),"1");
